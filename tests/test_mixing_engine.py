...
class TestAudioEffects:
    ...
    def test_compressor(self, test_audio):
        ...
        compressor = Compressor(sample_rate=44100, threshold=-10, ratio=4, attack=0.01, release=0.1)
    ...
    def test_reverb(self, test_audio):
        ...
        reverb = Reverb(sample_rate=44100, room_size=0.8, damping=0.5, wet_mix=0.5)
    ...
    def test_delay(self, test_audio):
        ...
        delay = Delay(sample_rate=44100, delay_time=0.1, feedback=0.5, wet_mix=1.0)  # 100ms
    ...
    def test_chorus(self, test_audio):
        """Test chorus effect."""
        chorus = Chorus(sample_rate=44100, num_voices=4, depth=0.02, rate=1.5, mix=0.5)
    ...
    def test_limiter(self, test_audio):
        ...
        limiter = Limiter(sample_rate=44100, threshold=-0.3, release=0.05)
    ...
    def test_gate(self, test_audio):
        ...
        gate = Gate(sample_rate=44100, threshold=-30, attack=0.001, release=0.1)
    ...
    def test_distortion(self, test_audio):
        ...
        distortion = Distortion(
            sample_rate=44100, drive=5.0, tone=0.7, output_gain=0.5, mode="soft"
        )
