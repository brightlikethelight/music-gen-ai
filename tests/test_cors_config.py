...
class TestCORSConfig:
    ...
    def test_allowed_domains(self):
        ...
        with patch.dict(
            os.environ,
            {"ENVIRONMENT": "production", "ALLOWED_DOMAINS": "example.com,test.io"},
            clear=True,
        ):
            config = CORSConfig()
    ...
    def test_is_origin_allowed(self):
        ...
        with patch.dict(
            os.environ,
            {"ENVIRONMENT": "development", "ALLOWED_ORIGINS": "https://custom.com"},
            clear=True,
        ):
            config = CORSConfig()
    ...
    def test_preflight_headers_invalid_origin(self):
        ...
        with patch.dict(os.environ, {"ENVIRONMENT": "production"}, clear=True):
            ...
            headers = config.get_preflight_headers(origin="https://evil.com", request_method="POST")
    ...
    def test_preflight_headers_invalid_method(self):
        ...
        with patch.dict(os.environ, {"ENVIRONMENT": "development"}, clear=True):
            ...
            headers = config.get_preflight_headers(
                origin="http://localhost:3000", request_method="TRACE"  # Not allowed
            )
...
async def test_cors_with_fastapi():
    ...
    with patch.dict(
        os.environ,
        {"ENVIRONMENT": "development", "ALLOWED_ORIGINS": "https://custom-app.com"},
        clear=True,
    ):
        app = create_app()
        ...
        response = client.get("/health", headers={"Origin": "https://custom-app.com"})
