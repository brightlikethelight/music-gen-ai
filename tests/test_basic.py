...
from music_gen.models.encoders import T5TextEncoder, ConditioningEncoder
from music_gen.utils.audio import normalize_audio, apply_fade
...
class TestBasicFunctionality:
    ...
    def test_audio_utils(self):
        ...
        assert torch.allclose(faded[0, fade_samples:fade_samples+100], audio[0, fade_samples:fade_samples+100], atol=1e-6)
...
def test_import_structure():
    ...
    import music_gen
    import music_gen.models
    import music_gen.models.transformer
    import music_gen.models.encodec
    import music_gen.training
    import music_gen.data
    import music_gen.evaluation
    import music_gen.utils
    import music_gen.api
