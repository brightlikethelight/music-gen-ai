...
from music_gen.models.transformer.config import TransformerConfig, MusicGenConfig
...
from music_gen.models.encoders import T5TextEncoder, ConditioningEncoder, MultiModalEncoder
