"""
Tests for music_gen.audio.separation.hybrid_separator
"""
...
from music_gen.audio.separation.hybrid_separator import *


class TestHybridSeparator:
    """Test hybrid_separator audio processing."""
