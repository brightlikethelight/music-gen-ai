...
app = typer.Typer(name="musicgen", help="MusicGen Unified - Simple instrumental music generation")
console = Console()
...
def generate(
    ...
    try:
        ...
        with Progress(
            ...
            generator = MusicGenerator(model_map[model], device=device, optimize=not no_optimize)
        ...
        with Progress(
            ...
            audio, sample_rate = generator.generate(
                prompt, duration, temperature, guidance, progress_callback
            )
