...
from music_gen.data.datasets import create_dataset, create_dataloader
...
def main():
    ...
    parser.add_argument("--model_path", type=str, required=True,
                       help="Path to model checkpoint or saved model")
    ...
    parser.add_argument("--duration", type=float, default=10.0,
                       help="Duration for benchmark generation")
