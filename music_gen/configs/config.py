...
class DataConfig:
    ...
    conditioning_vocab: Dict[str, Dict[str, int]] = field(
...
class TrainingConfig:
    ...
    sequence_length_schedule: List[tuple] = field(
        default_factory=lambda: [
...
class ExperimentConfig:
    ...
    sample_generation_steps: List[int] = field(
        default_factory=lambda: [1000, 5000, 10000, 25000, 50000]
    )
