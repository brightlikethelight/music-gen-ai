...
from ..models.multi_instrument import MultiInstrumentMusicGen, MultiTrackGenerator, TrackGenerationConfig
from ..audio.mixing import MixingEngine, MixingConfig, TrackConfig
from ..audio.separation import DemucsSeparator, SpleeterSeparator, HybridSeparator
...
def setup_multi_instrument_routes(app: FastAPI, model: MultiInstrumentMusicGen, temp_dir: Path):
    ...
    async def export_midi(
        ...
        return FileResponse(
            ...
            filename=f"converted_{instrument}.mid"
        )
