...
class MultiInstrumentConfig(TransformerConfig):
    ...
    instruments: Dict[str, InstrumentConfig] = field(
        default_factory=lambda: {
            ...
            "electric_piano": InstrumentConfig(
                "electric_piano", 4, (27.5, 4186.0), (1, 8), True, False, True
            ),
            "harpsichord": InstrumentConfig(
                "harpsichord", 6, (27.5, 4186.0), (2, 7), True, False, False
            ),
            "organ": InstrumentConfig("organ", 19, (16.35, 8372.0), (1, 9), True, False, True),
            "synthesizer": InstrumentConfig(
                "synthesizer", 38, (20.0, 20000.0), (0, 10), True, False, True
            ),
            # Strings
            ...
            "double_bass": InstrumentConfig(
                "double_bass", 43, (41.2, 440.0), (1, 4), True, False, True
            ),
            "harp": InstrumentConfig("harp", 46, (32.7, 3322.4), (1, 7), True, False, False),
            # Guitars
            "acoustic_guitar": InstrumentConfig(
                "acoustic_guitar", 24, (82.4, 880.0), (2, 5), True, False, False
            ),
            "electric_guitar": InstrumentConfig(
                "electric_guitar", 26, (82.4, 1318.5), (2, 6), True, False, False
            ),
            "bass_guitar": InstrumentConfig(
                "bass_guitar", 33, (41.2, 440.0), (1, 4), False, False, False
            ),
            # Brass
            ...
            "french_horn": InstrumentConfig(
                "french_horn", 60, (58.3, 698.5), (2, 5), False, False, True
            ),
            ...
            "clarinet": InstrumentConfig(
                "clarinet", 71, (146.8, 1568.0), (3, 6), False, False, True
            ),
            "saxophone": InstrumentConfig(
                "saxophone", 66, (103.8, 1396.9), (2, 6), False, False, True
            ),
            ...
            "xylophone": InstrumentConfig(
                "xylophone", 13, (523.3, 4186.0), (4, 7), False, True, False
            ),
            "vibraphone": InstrumentConfig(
                "vibraphone", 11, (174.6, 1396.9), (3, 6), True, True, True
            ),
            # Voice
            ...
            "bass_voice": InstrumentConfig(
                "bass_voice", 55, (87.3, 349.2), (2, 4), False, False, True
            ),
            # Additional
            "choir": InstrumentConfig("choir", 52, (87.3, 1046.5), (2, 6), True, False, True),
            "synth_pad": InstrumentConfig(
                "synth_pad", 88, (20.0, 20000.0), (0, 10), True, False, True
            ),
            "synth_lead": InstrumentConfig(
                "synth_lead", 80, (65.4, 4186.0), (2, 7), False, False, True
            ),
        }
    )
