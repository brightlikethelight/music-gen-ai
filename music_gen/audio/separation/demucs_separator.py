...
class DemucsSeparator(BaseSeparator):
    ...
    def _separate_with_demucs(
        ...
        # Apply separation
        _, separated = self.separator.separate_tensor(audio_np, sample_rate=self.sample_rate)
    ...
    def enhance_separation(
        self, stems: Dict[str, torch.Tensor], enhance_vocals: bool = True, reduce_bleed: bool = True
    ) -> Dict[str, torch.Tensor]:
