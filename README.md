...
[![CI Pipeline](https://github.com/brightlikethelight/music_gen/workflows/CI%20Pipeline/badge.svg)](https://github.com/brightlikethelight/music_gen/actions)
[![codecov](https://codecov.io/gh/brightlikethelight/music_gen/branch/main/graph/badge.svg)](https://codecov.io/gh/brightlikethelight/music_gen)
...
git clone https://github.com/brightlikethelight/music_gen.git
cd music_gen
pip install -e .
```
...
@software{musicgen_ai,
  ...
  author={Your Name},
  year={2024},
  url={https://github.com/brightlikethelight/music_gen}
}
```
...
- 🐛 **Issues**: [GitHub Issues](https://github.com/brightlikethelight/music_gen/issues)
